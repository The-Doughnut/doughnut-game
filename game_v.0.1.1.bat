...
echo There are __ lines of code.
echo ...
...
if %number% == 3 goto underBed
if %number% == 4 goto ignoreIpod
if %number% == Q goto reset
if %number% == q goto reset
goto breakfast
...
set /p choice=
if %choice% == 1 goto answerYes
if %choice% == 2 goto answerNo
if %choice% == 3 goto leaveMeAlone
if %choice% == 4 goto eatLunch
